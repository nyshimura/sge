...
try {
    $stmtSettings = $pdo->query("SELECT name, profilePicture FROM school_profile WHERE id = 1");
    $school = $stmtSettings->fetch();
    $schoolName = $school['name'] ?? 'Portal do Aluno';
} catch (Exception $e) {
...
<head>
    ...
    <title>Aluno - <?php echo htmlspecialchars($schoolName); ?></title>
    <link rel="stylesheet" href="../assets/css/student.css?v=1.2">
    ...
    <div class="main-content">
        <div class="top-bar" style="display:flex; justify-content:space-between; align-items:center;">
            ...
            <h2 style="margin:0; font-size:1.1rem; font-weight:600; color:#333; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width: 60%;">
                <?php echo isset($pageTitle) ? $pageTitle : 'Painel do Aluno'; ?>
            </h2>
